                        ...
                        <%-- Brand --%>
                            <div class="sidebar-brand">
                                ...
                                <div>
                                    ...
                                    <div class="sidebar-brand-sub">ICT 318 · L3</div>
                                </div>
                            </div>
                                        ...
                                        <c:choose>
                                            ...
                                            <c:when test="${userRole == 'ENSEIGNANT'}">
                                                <a href="${ctx}/notes"
                                                    ...
                                                    <span class="sidebar-nav-icon">◎</span>
                                                    <span>Saisie des notes</span>
                                                    <c:if test="${uri.contains('/notes')}"><span
                                                            class="sidebar-active-dot"></span></c:if>
                                                </a>
                                                <a href="${ctx}/etudiants"
                                                    class="${uri.contains('/etudiants') ? 'active' : ''}">
                                                    <span class="sidebar-nav-icon">◉</span>
                                                    <span>Étudiants</span>
                                                    <c:if test="${uri.contains('/etudiants')}"><span
                                                            class="sidebar-active-dot"></span></c:if>
                                                </a>
                                                <a href="${ctx}/bulletins"
                                                    class="${uri.contains('/bulletins') ? 'active' : ''}">
                                                    <span class="sidebar-nav-icon">▤</span>
                                                    <span>Bulletins</span>
                                                    <c:if test="${uri.contains('/bulletins')}"><span
                                                            class="sidebar-active-dot"></span></c:if>
                                                </a>
                                            </c:when>
                                            ...
                                            <c:when test="${userRole == 'ETUDIANT'}">
                                                ...
                                                <a href="${ctx}/statistiques"
                                                    ...
                                                    <c:if test="${uri.contains('/statistiques')}"><span
                                                            class="sidebar-active-dot"></span></c:if>
                                                </a>
                                            </c:when>
                                        </c:choose>
                                    ...
                                    <div class="sidebar-user">
                                        <div class="sidebar-user-card">
                                            ...
                                            <div style="flex:1; min-width:0;">
                                                ...
                                                <div class="sidebar-user-role" style="color: ${roleColor};">${roleLabel}
                                                </div>
                                            </div>
                                        </div>
