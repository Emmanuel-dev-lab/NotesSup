                ...
                <form method="POST" action="${pageContext.request.contextPath}/notes">
                    ...
                    <div class="form-group">
                        ...
                        <select id="etudiant" name="etudiant_id" required>
                            ...
                            <c:forEach var="etudiant" items="${etudiants}">
                                <option value="${etudiant.id}" ${note != null && note.etudiantId == etudiant.id ? 'selected' : ''}>
                    ...
                    <div class="form-group">
                        ...
                        <select id="matiere" name="matiere_id" required>
                            ...
                            <c:forEach var="matiere" items="${matieres}">
                                <option value="${matiere.id}" ${note != null && note.matiereId == matiere.id ? 'selected' : ''}>
                    ...
                    <div class="form-grid">
                        <div class="form-group">
                            ...
                            <input
                                ...
                                id="noteCC"
                                name="note_cc"
                                value="${note != null && note.noteCC != null ? note.noteCC : ''}"
                                min="0"
                                max="20"
                                step="0.5"
                                required
                    ...
                    <div class="form-group">
                        ...
                        <select id="session" name="session" required>
                            ...
                            <option value="RATTRAPAGE" ${note != null && note.session == 'RATTRAPAGE' ? 'selected' : ''}>
                                Session Rattrapage
                            </option>
                        </select>
                    </div>
